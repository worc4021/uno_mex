...
uno_int constraint_functions(	uno_int /*number_variables*/, 
...
uno_int objective_gradient(	uno_int /*number_variables*/, 
							const double* x, 
							double* gradient, 
							void* /*user_data*/) {
...
uno_int constraint_jacobian(	uno_int /*number_variables*/, 
...
uno_int lagrangian_hessian(	uno_int /*number_variables*/, 
							uno_int /*number_constraints*/, 
...
uno_int lagrangian_hessian_operator(uno_int number_variables, 
									uno_int number_constraints, 
									const double* x,
      								bool evaluate_at_x, 
									double objective_multiplier, 
...
*/
	if (!uno_set_initial_primal_iterate(model, x0))
		throw std::runtime_error("Failed to set initial primal iterate.");
	// solver creation
